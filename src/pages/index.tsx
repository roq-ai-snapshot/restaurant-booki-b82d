  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine: Revolutionizing Dining Experiences with Seamless Reservations and Efficient Management for Restaurant Staff."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine: Revolutionizing Dining Experiences with Seamless Reservations and Efficient Management for Restaurant Staff.`}
            </Text>
            <Box
